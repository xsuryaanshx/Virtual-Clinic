...
const mockPatients = [
  { id: 1, name: 'Patient A', urgency: 'high' as const, summary: 'Dolore toracico acuto con dispnea', age: 54, wait: '2 min' },
  { id: 2, name: 'Patient B', urgency: 'medium' as const, summary: 'Sintomi influenzali persistenti da 5 giorni', age: 32, wait: '5 min' },
  { id: 3, name: 'Patient C', urgency: 'low' as const, summary: 'Controllo di routine post-operatorio', age: 41, wait: '8 min' },
];

const urgencyConfig = {
  high: { icon: AlertTriangle, color: 'text-urgency-high', bg: 'bg-urgency-high/10', label: 'Alto' },
  medium: { icon: AlertCircle, color: 'text-urgency-medium', bg: 'bg-urgency-medium/10', label: 'Medio' },
  low: { icon: CheckCircle, color: 'text-urgency-low', bg: 'bg-urgency-low/10', label: 'Basso' },
};
                    ...
                    <div className="flex items-start gap-4 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center gap-2 mb-1">
                          ...
                          <span className="text-xs text-muted-foreground">{patient.age} anni · {patient.wait}</span>
                        </div>
