  ...
  return (
    <PageTransition>
      <div className="fixed inset-0 bg-foreground flex flex-col lg:flex-row z-50">
        ...
        {/* Sidebar - desktop always, mobile togglable */}
        <motion.div
          ...
          } lg:block w-full lg:w-80 bg-card border-t lg:border-t-0 lg:border-l border-border p-5 sm:p-6 overflow-y-auto max-h-[40vh] lg:max-h-none`}
        >
          ...
          <div className="space-y-4 lg:space-y-6">
            <div className="bg-secondary rounded-2xl p-4 sm:p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground">Patient B</p>
                  <p className="text-xs text-muted-foreground">32 y/o</p>
                </div>
              </div>
            </div>
